    ...
    enum Scene {
        enum Main {
            enum MenuBar {
                ...
                static let repositoryButton = String(
                    localized: "Scene.Main.MenuBar.RepositoryButton")
            }

            enum AboutWindow {
                static let repositoryButton = String(
                    localized: "Scene.Main.AboutWindow.RepositoryButton")
            }

            enum SettingsAlert {
                static let libraryParameters = String(
                    localized: "Scene.Main.SettingsAlert.LibraryParameters")
            ...
            enum Toggles {
                ...
                static let VPNSensitivity = String(localized: "Scene.Main.Toggles.VPNSensitivity")
                static let dockIcon = String(localized: "Scene.Main.Toggles.DockIcon")
            }
        }
    }
