...
struct MainScene: Scene {
    private typealias Strings = LocalizedString.Scene.Main
    ...
    var body: some Scene {
        ...
        .commands {
            CommandGroup(replacing: .appInfo) {
                Button(
                    Strings.MenuBar.aboutButton(appName: appName)
                ) {
                    openAboutWindow()
                }

                Button(Strings.MenuBar.updatesButton) {
                    updateService.checkAvailability(isManual: true)
                }
            }
            ...
            CommandGroup(replacing: .help) {
                Button(Strings.MenuBar.repositoryButton) {
    ...
    private func openAboutWindow() {
        ...
        let firstLink = Strings.AboutWindow.repositoryButton
